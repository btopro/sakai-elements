# sakai-elements
[![Published on npm](https://img.shields.io/npm/v/@sakai-elements/sakai-elements.svg?style=flat)](https://www.npmjs.com/package/@sakai-elements/sakai-elements)
[![Build Status](https://travis-ci.org/sakaiproject/sakai-elements.svg?branch=master)](https://travis-ci.org/sakaiproject/sakai-elements)
[![Dependency Status](https://img.shields.io/david/sakaiproject/sakai-elements.svg?style=flat)](https://david-dm.org/sakaiproject/sakai-elements)
[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://www.webcomponents.org/author/sakaiproject)
Welcome to the sakai-elements project!
...
```bash
$ git clone git@github.com:btopro/sakai-elements.git
$ cd sakai-elements
$ yarn install
$ yarn start
```
...
- `$ yarn test`
    -  Run tests on ALL sakai-elements.
- `$ yarn run build`
    -  Run build on ALL sakai-elements.
- `$ yarn run storybook`
    - Run storybook
- `$ yarn run build-storybook`
    - Build storybook for deployment
- `$ lerna publish`
    - Publish ALL sakai-elements' elements to npmjs.com
...
To test all sakai-elements, run `yarn test` from the root of the repo. If you only want to test the web component you're working on:
...
Then open the URL that will be printed in the terminal. It looks something like this: `http://localhost:8081/components/@@sakai-elements/sakai-elements/generated-index.html?cli_browser_id=0`.

## Storybook

We've added [Storybook](https://storybook.js.org/) to sakai-elements as a way to preview our web components as they are being developed. We'll also use Storybook to export a static site that will be the demo site for sakai-elements.
...
```js
"../../whatwg-fetch/fetch.js": path.join( // this is the third-party dependency in the sakai-elements
  __dirname,
