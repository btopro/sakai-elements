...
class SakaiRubricsManager extends SakaiElement {
  ...
  render() {
    return html`
      ...
      <div role="tablist">
        <div
          id="site-rubrics-title"
          aria-expanded="${this.siteRubricsExpanded}"
          role="tab"
          aria-multiselectable="true"
          class="manager-collapse-title"
          title="${tr("toggle_site_rubrics")}"
          tabindex="0"
          @click="${this.toggleSiteRubrics}"
        >
          <div>
          ...
          <div class="hidden-xs">
            <sr-lang key="site_title">site_title</sr-lang>
          </div>
          <div class="hidden-xs">
            <sr-lang key="creator_name">creator_name</sr-lang>
          </div>
          <div class="hidden-xs">
            <sr-lang key="modified">modified</sr-lang>
          </div>
        ...
        <div
          role="tabpanel"
          aria-labelledby="site-rubrics-title"
          id="site_rubrics"
        >
          <sakai-rubrics-list
        ...
        <div
          id="shared-rubrics-title"
          aria-expanded="${this.sharedRubricsExpanded}"
          role="tab"
          aria-multiselectable="true"
          class="manager-collapse-title"
          title="${tr("toggle_shared_rubrics")}"
          tabindex="0"
        ...
        <div
          role="tabpanel"
          aria-labelledby="shared-rubrics-title"
          id="shared_rubrics"
        >
          <div id="sharedlist">
            <sakai-rubrics-shared-list
              token="Bearer ${this.token}"
              id="sakai-rubrics-shared-list"
              @copy-share-site="${this.copyShareSite}"
            ></sakai-rubrics-shared-list>
          </div>
        </div>
