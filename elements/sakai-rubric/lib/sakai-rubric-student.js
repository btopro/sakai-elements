      ...
      ${this.preview
        ...
        : html`
            <sakai-rubric-criterion-student
              ...
              evaluation-details="${JSON.stringify(
        ...
        if (data._embedded["rubric-associations"].length) {
          ...
          $.ajax({
            ...
            .done(rubric => {
              ...
              $.ajax({
                url: `/rubrics-service/rest/evaluations/search/by-tool-item-and-associated-item-and-evaluated-item-ids?toolId=${
                  this.toolId
                }&itemId=${this.entityId}&evaluatedItemId=${
