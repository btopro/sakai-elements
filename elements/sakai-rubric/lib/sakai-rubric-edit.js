...
export class SakaiRubricEdit extends SakaiElement {
  ...
  render() {
    return html`
      ...
      <div
        id="edit_rubric_${this.rubric.id}"
        @click="${this.eatEvent}"
        class="popover rubric-edit-popover bottom"
      >
        <div class="arrow"></div>
        ...
        <div class="popover-content form">
          <div class="form-group">
            ...
            <input
              title="${tr("rubric_title")}"
              name="rubric_title_edit"
              type="text"
              class="form-control"
  ...
  editRubric(e) {
    e.stopPropagation();
    this.dispatchEvent(
      new CustomEvent("show-tooltip", { detail: this.rubric })
    );
  ...
  hideToolTip() {
    ...
    this.dispatchEvent(
      new CustomEvent("hide-tooltip", { detail: this.rubric })
    );
  }
  ...
  saveEdit(e) {
    ...
    this.dispatchEvent(
      new CustomEvent("update-rubric-title", { detail: title })
    );
    $(`#edit_rubric_${this.rubric.id}`).hide();
    this.hideToolTip();
  }
