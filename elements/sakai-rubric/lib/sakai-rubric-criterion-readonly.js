                    ...
                    <div class="cr-table-row">
                      ${c.ratings.map(
                        r => html`
                          <div
                            tabindex="0"
                            title$="Rating Title: ${r.title}. Rating Description: ${r.description}. Point Value: ${r.points}"
                            class="rating-item"
                            id="rating_item_${r.id}"
                            on-save-ratings="saveRatings"
                            @on-delete-rating="${this.deleteCriterionRating}"
                          >
